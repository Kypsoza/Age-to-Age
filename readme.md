...
**Ajouts**
- La Caserne (une fois construite, maison niv.2 requis) permet d'assigner des habitants comme soldats (➖➕ sur la carte, dans le panneau de droite/la fiche mobile), chaque soldat apportant 8 points de Défense
- Vagues d'assaut automatiques toutes les 90s une fois la Caserne construite : seuils 50 → 65 → 85 → 110 → 145 (vague 1 à 5), puis la 5ᵉ vague se répète en boucle au seuil 145 sans jamais dépasser ce seuil
- Défense suffisante à l'arrivée de la vague = vague repoussée sans perte. Défense insuffisante = -25% de CHAQUE ressource stockée (Bois/Pierre/Nourriture/Or)
- Indicateur de compte à rebours avant la prochaine vague (topbar PC et mobile), qui passe en rouge dans les 15 dernières secondes
- Panneau dédié (fiche Caserne, PC et mobile) : soldats assignés, score de Défense courant vs seuil de la vague en cours, temps restant avant l'assaut
